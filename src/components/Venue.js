    ...
    return (
        <div className='w-full flex p-8'>
            <div className='flex flex-col md:w-80 lg:w-[400px]'>
                ...
                <h3 className='sm:text-xl md:text-lg lg:text-xl text-[#005720] font-light'>Blue Tree Premium Morumbi, Sau Paulo</h3>
                <img className='w-80 md:h-48 my-4' src={venue}></img>
