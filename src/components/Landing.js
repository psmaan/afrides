const Landing = () => {
    return (
        <div className='w-screen h-screen sm:min-h-[700px] flex flex-col items-center landing pt-24 sm:pt-32 sm:pt-16  md:pt-12 lg:pt-16 bg-[#95d5b2] z-10'>
            ...
            <h2 className="text-center text-3xl text-[#35bc3d] md:text-[#005720] font-bold mt-2">SAU PAULO EDITION</h2>
