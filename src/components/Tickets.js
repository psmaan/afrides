    ...
    return (
        <div className='w-full bg-[#95d5b2] flex flex-col items-center py-12'>
            ...
            <div className='flex flex-col lg:flex-row items-center mt-8'>
                <div className='bg-white/20 h-[580px] lg:h-[630px] w-[360px]  sm:w-[500px] lg:w-[300px] xl:w-[380px] backdrop-blur-3xl rounded-3xl flex flex-col items-center p-4 py-8 mx-2 lg:mx-4 border-2 border-white/20 hover:scale-105 duration-200 my-4'>
                    <h1 className='text-white font-bold text-4xl'>Basic</h1>
                    <img className='w-[90px] my-2' src={ticket}></img>
                    <h1 className='text-4xl text-[#005720] font-bold'>$100</h1>
                    ...
                    <div className='flex flex-col items-start w-[95%]'>
                        ...
                        <div className='flex items-center border-b-[1px] pb-1 w-full my-1'>
                            ...
                            <h1 className='text-white font-light text-sm lg:text-md'>Coffee breaks and light refreshments.
                            </h1>
                        </div>
                ...
                <div className='bg-white/20 lg:h-[650px] w-[360px] sm:w-[500px] lg:w-[320px] xl:w-[400px] backdrop-blur-3xl rounded-3xl flex flex-col items-center p-4 py-8 mx-2 lg:mx-4 border-2 border-white/20 hover:scale-105 duration-200 my-4'>
                    <h1 className='text-white font-bold text-4xl'>Standard</h1>
                    <img className='w-[90px] my-2' src={ticket}></img>
                    <h1 className='text-4xl text-[#005720] font-bold'>$300</h1>
                    <button className='m-4 font-semibold rounded-lg p-2 px-4 bg-[#35bc3d] text-white hover:scale-110 duration-150 mb-8'>Buy Now</button>
                    <div className='flex flex-col items-start w-[95%]'>
                        <div className='flex items-center border-b-[1px] pb-1 w-full my-1'>
                            <div className='w-5 h-5 bg-[#35bc3d] rounded-full mr-3 flex justify-center items-center'>
                ...
                <div className='bg-white/20 h-[580px] lg:h-[630px] w-[360px] sm:w-[500px] lg:w-[300px] xl:w-[380px] backdrop-blur-3xl rounded-3xl flex flex-col items-center p-4 py-8 mx-2 lg:mx-4 border-2 border-white/20 hover:scale-105 duration-200 my-4'>
                    ...
                    <div className='flex flex-col items-start w-[95%]'>
                        ...
                        <div className='flex items-center pb-1 w-full my-1'>
                            ...
                            <h1 className='text-white font-light text-sm lg:text-md w-[90%]'>⁠Entry to the VIP networking lounge.
