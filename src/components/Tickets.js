    ...
    return (
        <div className='w-full bg-[#95d5b2] flex flex-col items-center py-12'>
            ...
            <div className='flex flex-col md:flex-row items-center mt-8'>
                <div className='bg-white/20 h-[580px] lg:h-[650px] w-[360px] lg:w-[300px] xl:w-[400px] backdrop-blur-3xl rounded-3xl flex flex-col items-center p-4 py-8 mx-2 lg:mx-4 border-2 border-white/20 hover:scale-105 duration-200 my-4'>
                ...
                <div className='bg-white/20 h-[580px] lg:h-[650px] w-[360px] lg:w-[300px] xl:w-[400px] backdrop-blur-3xl rounded-3xl flex flex-col items-center p-4 py-8 mx-2 lg:mx-4 border-2 border-white/20 hover:scale-105 duration-300 my-4'>
